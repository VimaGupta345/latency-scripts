...
MODEL_PATH="/scratch/vgupta345/models_dir/Qwen2-57B-A14B-Instruct"
MODEL_NAME="qwen"
PORT=8001
TP_SIZE=2
GPUS="2,3"
...
configs=(
    "/nethome/vgupta345/prowl/configs/qwen/qwen_do-nothing.json"
    "/nethome/vgupta345/prowl/configs/qwen/alpha0.5_beta1.25.json"
    "/nethome/vgupta345/prowl/configs/qwen/alpha0.5_beta2.json"
)
